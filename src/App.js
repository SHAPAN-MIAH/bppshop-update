...
import Brands from './Pages/Brand/BrandsPage/Brands';
...
import BrandsProducts from './Pages/Brand/BrandsProductsPage/BrandsProducts';
...
import BrandProductDetails from "./Pages/Brand/BrandsProductDetailsPage/BrandProductDetails";
...
import SellerStoreProductDetails from "./Pages/SellerStore/SellerStoreProductDetailsPage/SellerStoreProductDetails";
    ...
    <div className="App">
      <Layout>
        <Routes>
          ...
          <Route path="/hot-deals/:id" element={<HotDealsProductDetails/>} />
