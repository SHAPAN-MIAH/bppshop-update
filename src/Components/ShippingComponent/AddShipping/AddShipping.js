...
const AddShipping = () => {
  ...
  const handleDistrictChange = (e) => {
    ...
    axios.get(baseUrl + `/location/thanas/${districtId}`).then((res) => {
  ...
  const submitFailedBtn = () => {
    document.querySelector(".submitFailedAlert").innerHTML =
      "Please Select District, Thana and Area.";
  };
      ...
      <div className="shipping_Add_container">
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className="shipping_add_close_btn">
            ...
            <div>
              {address == null || areaId == null ? (
                <input
                  onClick={submitFailedBtn}
                  className="submitFailedBtn"
                  value="Save"
                />
              ) : (
                <input
